...
from core.navegador import get_chrome_driver

import getpass

from core.auth import login_generic

from core.ucampus import extraer_datos_ucampus

from export.excel_exporter import excel_exporter
...
try:
    ...
    path = salida
    excel_exporter(file_name,path,df_indicadores, df_cursos, df_semestre, df_dictados, df_examenes, df_UB, df_UB_eliminadas, df_recuento)
except:
